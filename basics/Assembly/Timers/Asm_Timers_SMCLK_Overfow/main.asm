...
;----setup LED initially
            bis.b    #BIT0, &P1DIR
            bic.b    #BIT0, &P1OUT                       ; set LED = OFF
            bic.b    #LOCKLPM5, &PM5CTL0                 ; enabled digit I/O

;----timer setup B0
            bis.w    #TBCLR, &TB0CTL                     ; clear TB0
            bis.w    #TBSSEL__SMCLK, &TB0CTL             ; choose SMCLK as clock source
...
;-----timer overflow IRQ setup
            ...
            bis.w    #GIE, SR                            ; enable global interrupt for all maskables(could use eint)
